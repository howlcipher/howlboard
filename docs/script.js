...
// Site chrome only.
//
// The mission-control showcase is no longer implemented here. It is compiled
// from docs/demo.howl through the HowlFrame JavaScript backend to docs/demo.js
// and imports the same rendering module as the application, so the published
// demo and the product cannot drift apart.
